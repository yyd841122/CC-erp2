...
import { getSupplierList, deleteSupplier, createSupplier } from '@/api/supplier'
...
const handleExport = async () => {
  try {
    loading.value = true
    const data = await getSupplierList({ page: 1, size: 10000 })
    ...
    exportToExcel(exportData, excelColumns, '供应商数据.xlsx')
...
const handleDownloadTemplate = () => {
  downloadTemplate(excelColumns, '供应商导入模板.xlsx')
}
